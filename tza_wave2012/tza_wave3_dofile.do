...
collapse  region ea district rural (sum) total_qty  total_valuefert  (max)  dist_cens tpricefert_cens_mrk, by(y3_hhid)
...
gen year = 2012
sort HHID
save "${tza_GHS_W3_created_data}\panell\tanzania_wave3_completedata_2012.dta", replace
...
merge m:1 HHID using "${tza_GHS_W3_created_data}\panell\tanzania_wave3_completedata_2012.dta", gen(file)
