...
collapse region ea district rural (sum)  total_qty total_valuefert  (max)  dist_cens tpricefert_cens_mrk, by(y4_hhid)
...
ren y4_hhid HHID
keep HHID region ea district rural dist_cens_w total_qty_w total_valuefert real_tpricefert_cens_mrk
...
gen year = 2014
sort HHID
save "${tza_GHS_W4_created_data}\panell\tanzania_wave4_completedata_2014.dta", replace
...
merge m:1 HHID using "${tza_GHS_W4_created_data}\panell\tanzania_wave4_completedata_2014.dta", gen(file)
...
duplicates report HHID
*duplicates drop HHID, force
order HHID total_valuefert total_qty_w dist_cens_w real_tpricefert_cens_mrk subsidy_qty_w

gen comm_dumm = (total_qty_w >0)
...
save "C:\Users\obine\Music\Documents\Smallholder lsms STATA\analyzed_data\tza_wave2014\panell\complete_panel.dta", replace
...
merge 1:m UPHI using "C:\Users\obine\Music\Documents\Smallholder lsms STATA\analyzed_data\tza_wave2014\panell\complete_panel.dta", gen(fil)
